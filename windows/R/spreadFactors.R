                  ...
                  for (t in 1:nberOfExtractionFiles) {
                    ...
                    if (randomWalkDistance == TRUE) {
                      ...
                      mat[branchesNotNA, 1] = circuitScape(hullRasters[[h]], 
                        envVariableName, resistances[[h]], avgResistances[[h]], 
                        fourCells, fromCoor_temp, toCoor_temp, 
                    ...
                    for (t in 1:nberOfExtractionFiles) {
                      ...
                      if (randomWalkDistance == TRUE) {
                        ...
                        mat[branchesNotNA, ] = circuitScape(simRasters[[h]], 
                          simRasterName, resistances[[h]], avgResistances[[h]], 
                          fourCells, fromCoorRand[[t]][branchesNotNA, 
